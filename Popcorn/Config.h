...
public:
	...
	static const AColor BG_Color, Red_Color, Blue_Color, White_Color, Letter_Color, Laser_Color, Gate_Color, BG_Outline_Color;
	static const AColor Teleport_Portal_Color;
	static const AColor Unbreakable_Blue_Highlight, Unbreakable_Red_Highlight;
	static const AColor Advertisement_Red_Table, Advertisement_Blue_Table;
	static const AColor Monster_Cornea_Color, Monster_Dark_Red_Color, Monster_Iris_Color, Monster_Comet_Tail;
	static const AColor Explosion_Red_Color, Explosion_Blue_Color;
	static const AColor Shadow_Color, Highlight_Color;
	static const AFont Name_Font, Score_Font, Logo_Pop_Font,Logo_Clone_Font,Game_Over_Font;
	...
	static const int Max_Mop_Indicator_Fade_Step = AsConfig::FPS * 4 / 10; // 0.4 seconds
