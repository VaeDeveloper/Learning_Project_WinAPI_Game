...
//------------------------------------------------------------------------------------------------------------
void AFalling_Letter::Test_Draw_All_Step(HDC hdc)
{
	int i;
...
{// Вывод падающей буквы
	...
	if (!(Brick_Type == EBrick_Type::Blue || Brick_Type == EBrick_Type::Red)) return;  // Падающие буквы могут быть только от кирпичей такого типа
