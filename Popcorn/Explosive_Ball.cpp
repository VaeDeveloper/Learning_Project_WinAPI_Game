...
//                                   AExplosion_Ball
//------------------------------------------------------------------------------------------------------------
AExplosion_Ball::AExplosion_Ball()
	:Explosive_Ball_State(EExplosive_Ball_State::Idle), Is_Red(false), X_Pos(0), Y_Pos(0), Max_Size(0.0),
	Step_Count(0), Start_Expanding_Tick(0), Start_Fading_Tick(0), Time_Offset(0), Size(0.0), Size_Step(0.0), Ball_Rect{}
{
}
//------------------------------------------------------------------------------------------------------------
void AExplosion_Ball::Act()
{
...
//------------------------------------------------------------------------------------------------------------
void AExplosion_Ball::Clear(HDC hdc, RECT& paint_area)
{
}
//------------------------------------------------------------------------------------------------------------
void AExplosion_Ball::Draw(HDC hdc, RECT& paint_area)
{
	int curr_timeout;
	int color_index;
	double ratio;
...
//------------------------------------------------------------------------------------------------------------
bool AExplosion_Ball::Is_Finished()
{
...
//------------------------------------------------------------------------------------------------------------
void AExplosion_Ball::Explode(int x_pos, int y_pos, int size, bool is_red, int time_offset, int step_count)
{
	X_Pos = x_pos;
	Y_Pos = y_pos;
	Max_Size = size;
	...
	Size_Step = Max_Size / (double)Step_Count;

	Update_Ball_Rect();
}
//------------------------------------------------------------------------------------------------------------
void AExplosion_Ball::Update_Ball_Rect()
{
